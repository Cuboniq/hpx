...
namespace hpx::threads {
    ...
    public:
        ...
        static threads::thread_description get_description()
        {
            return {"<unknown>"};
        }
        static threads::thread_description set_description(
            threads::thread_description /*value*/)
        {
            return {"<unknown>"};
        }

        static threads::thread_description get_lco_description()    //-V524
        {
            return {"<unknown>"};
        }
        static threads::thread_description set_lco_description(    //-V524
            threads::thread_description /*value*/)
        {
            return {"<unknown>"};
        }
